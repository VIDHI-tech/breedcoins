...
const BookListPrimary = () => {
  ...
  return (
    <section id="academics_primary_wing" className="border-b-2 py-20">
      <InfoSection
        ...
        button={{
          label: "Read PDF",
          link: dataFiltered?.book_list_primary_wing_pdf ?? "#",
        }}
      />
    </section>
  );
...
export default BookListPrimary;
