...
export const StudentCouncilAvTable = () => {
  const { data } = useApiQuery(endpoints.entities.table_student_council_av.all);
  const tableFilteredData = useMemo(() => data?.data?.data ?? [], [data]);
  // console.log("studentcouncilav", tableFilteredData);
